...
video="./datasets/udon11h/ch201.mp4"
exp="./custom_exp/udon201.py"
...
declare -a StringArray=("./pretrained/yolox_2023_10_26_79.tar" "./pretrained/bytetrack_l_mot17.pth.tar" "./pretrained/freeze_backbone_epoch20.tar")                        
